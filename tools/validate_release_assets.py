"""Static release-asset validation for the Swin2SR 2x super-resolution DIMER pipeline.
...
EXPECTED_MODEL_ID = "caidas/swin2SR-classical-sr-x2-64"
...
EXPECTED_OUTPUTS = (
    "outputs/swin2sr_super_resolution_train.csv",
    "outputs/swin2sr_super_resolution_input_manifest.json",
    "outputs/swin2sr_super_resolution_evaluation_report.json",
    "outputs/swin2sr_super_resolution_output_frozen.png",
    "outputs/swin2sr_super_resolution_output_adapted.png",
    "outputs/swin2sr_super_resolution_examples",
    "outputs/swin2sr_super_resolution_adapter",
    "outputs/swin2sr_super_resolution_result.json",
)
...
CODE_MARKERS = (
    ...
    "write_dataset_csv(train_records, 'outputs/swin2sr_super_resolution_train.csv')",
    "validate_dataset(probe)",
    "print({'ceilings': {'MIN_INPUT_SIDE': MIN_INPUT_SIDE, 'MAX_INPUT_SIDE': MAX_INPUT_SIDE, 'UPSCALE': UPSCALE, 'HR_CROP': HR_CROP, 'MIN_RECORDS': MIN_RECORDS, 'MAX_RECORDS': MAX_RECORDS",
    ...
    "report = evaluation_report(result, scene_reference, low_resolution=scene_input, sample_kind=",
    ...
    "pipe.save_artifact(artifact_dir, metadata={'tutorial': 'swin2sr_super_resolution', 'data_source': data_source})",
...
MARKDOWN_MARKERS = (
    "**Capability:** 2× single-image super-resolution (classical SR) and bounded supervised fine-tuning",
    "**Apache-2.0** licence",
    "**synthesised** from what the input contains",
    "**adaptation with paired crops**",
    "**CC0 1.0**",
    "**and then JPEG compression at quality 40**",
    ...
    "**Snapshot note:**",
    "scales other than 2×, blind restoration of unknown degradations",
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    9_868_140: "adapter.safetensors from save_artifact (default one stage + tail)",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "827eb4a31619d7073a825ce5e5a46b58f26e07b3c920d6cf75b6f11a1241ca83": "SAMPLE_DIGEST: dataset_digest of the default seeded iNaturalist draw",
}
